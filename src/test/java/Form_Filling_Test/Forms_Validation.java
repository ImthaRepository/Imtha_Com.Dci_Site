...
//Select interested
		forLoop(multipleelements("//select[@id='wpforms-49671-field_7']//option"),
				"//select[@id='wpforms-49671-field_7']//option", 2, 500);
		info("Select Interest is Validated");
		sleep(1000);

//Select Budget	
		forLoop(multipleelements("//select[@id='wpforms-49671-field_9']//option"),
				"//select[@id='wpforms-49671-field_9']//option", 2, 500);
		info("Budget Field is Validated");

//Requirement Text field
		sendKeys(locatorId("wpforms-49671-field_10"),
				"This message is for Testing purpose .So Kindly Ignore this Message");
...
//Select interested
		forLoop(multipleelements("//select[@id='wpforms-55259-field_9']//option"),
				"//select[@id='wpforms-55259-field_9']//option", 2, 500);
		info("Select Interest is Validated");
...
//Select Budget	
		forLoop(multipleelements("//select[@id='wpforms-55259-field_32']//option"),
				"//select[@id='wpforms-55259-field_32']//option", 2, 500);
		info("Budget Field is Validated");

//Requirement Text field
		sendKeys(locatorId("wpforms-55259-field_25"),
				"This message is for Testing purpose .So Kindly Ignore this Message");
		info("Requirement Field is validated");
...
//Select Post
		forLoop(multipleelements("//select[@id='wpforms-50096-field_4']//option"),
				"//select[@id='wpforms-50096-field_4']//option", 2, 200);
		info("Select Post is Validated");

//Select Location
		forLoop(multipleelements("//select[@id='wpforms-50096-field_5']//option"),
				"//select[@id='wpforms-50096-field_5']//option", 2, 500);
		info("Location Field is Validated");

//Select Search Engine
		forLoop(multipleelements("//select[@id='wpforms-50096-field_6']//option"),
				"//select[@id='wpforms-50096-field_6']//option", 2, 300);
...
//Select Year of Experience    
		forLoop(multipleelements("//select[@id='wpforms-50096-field_8']//option"),
				"//select[@id='wpforms-50096-field_8']//option", 2, 100);
		info("Year of Experience Field is Validated");

//Select Month of Experience   		
		forLoop(multipleelements("//select[@id='wpforms-50096-field_9']//option"),
				"//select[@id='wpforms-50096-field_9']//option", 2, 100);
...
//Key Skills field		    
		sendKeys(locatorXpath("//textarea[@id='wpforms-50096-field_11']"),
				"This message is for Testing purpose only.So Kindly Ignore this Message");
...
//Upload Resume
		/*
		 * uploadFile(locatorXpath("//div[@class='dz-message']")
		 * ,"C:\\Users\\Ram prathees\\Downloads\\CV.pdf" ); info("Resume Uploaded");
		 */
...
//Send Button
	...
	public void SendMessageForm() throws InterruptedException {
		...
		/*// Close the Frame
		WaitUntilClcikable(locatorXpath("(//button[@data-text='Minimize'])[1]"));
...
//Name Field
		WaitUntilClcikable(locatorXpath("//input[@name='name']"));
...
//Interested Services
		...
		try {
			forLoop(multipleelements("//label[@class='tawk-checkbox-container']"),
					"//label[@class='tawk-checkbox-container']", 1, 200);
...
//Message Field
		try {
			sendKeys(locatorXpath("//textarea[@aria-placeholder='Message']"),
					"This message is for Testing purpose .So Kindly Ignore this Message");
			info("Message field Validated");
		} catch (Exception e) {
			sendKeys(locatorXpath("//textarea[@aria-placeholder='Requirement']"),
					"This message is for Testing purpose .So Kindly Ignore this Message");
...
//Submit Button
		/*
		 * try { click(locatorXpath("//button//p[text()=' Submit ']"));
		 * info("submit button clicked"); } catch (Exception e) {
...
//Number of Employees
		...
		forLoop(multipleelements("//select[@id='wpforms-49913-field_22']//option"),
				"//select[@id='wpforms-49913-field_22']//option", 2, 400);
		info("Number of employees is Validated");

//Company Type

		forLoop(multipleelements("//select[@id='wpforms-49913-field_26']//option"),
				"//select[@id='wpforms-49913-field_26']//option", 2, 500);
		info("Company Type is Validated");

//Industry Experience

		forLoop(multipleelements("//select[@id='wpforms-49913-field_27']//option"),
				"//select[@id='wpforms-49913-field_27']//option", 2, 500);
		info("Industry Experience Field is Validated");
		ScrollJS(0, 150);

//Tech Expertise

		forLoop(multipleelements("//ul[@id='wpforms-49913-field_28']//li//input"),
				"//ul[@id='wpforms-49913-field_28']//li//input", 1, 200);
		forLoop(multipleelements("//ul[@id='wpforms-49913-field_28']//li//input"),
				"//ul[@id='wpforms-49913-field_28']//li//input", 1, 200);
...
//Job Title of contact person
		...
		/*
		 * ScrollJS(0, 150); //Country code(Contact Number)
		 * click(locatorXpath("//div[@class='iti__flag-container']")); sleep(1000);
		 * forLoop(multipleelements("//ul[@id='iti-0__country-listbox']//li"),
		 * "//ul[@id='iti-0__country-listbox']//li", 4, 10);
		 * info("Countries code Selection is Validated"); sleep(2000);
		 */
...
//Brief Description about the company
		sendKeys(locatorXpath("//textarea[@id='wpforms-49913-field_50']"),
				"This message is for Testing purpose.So Kindly Ignore this Message");
